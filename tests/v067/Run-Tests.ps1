param([string[]]$Names=@('notification-recovery-tests'))
...
$classes=@{'notification-recovery-tests'='NotificationRecoveryTests';'live-notification-check'='LiveNotificationCheck'}
