param([string[]]$Names=@('layout-tests'))
...
$classes=@{'layout-tests'='LayoutTests'}
foreach($name in $Names){
 ...
 if($name -match 'layout|ui|music-position'){Copy-Item -LiteralPath (Join-Path $bundle 'assets') -Destination $runtime -Recurse}
