param([string[]]$Names=@('usability-tests','usability-ui-tests','polish-tests','polish-ui-tests','comfort-tests','comfort-ui-tests-v050','hotkey-tests','music-position-tests'))
...
$classes=@{'usability-tests'='UsabilityTests';'usability-ui-tests'='UsabilityUiTests';'polish-tests'='PolishTests';'polish-ui-tests'='PolishUiTests';'comfort-tests'='ComfortTests';'comfort-ui-tests-v050'='ComfortUiTests';'hotkey-tests'='HotkeyTests';'music-position-tests'='MusicPositionTests'}
foreach($name in $Names){
 ...
 if($name -match 'ui|music-position'){Copy-Item -LiteralPath (Join-Path $bundle 'assets') -Destination $runtime -Recurse}
